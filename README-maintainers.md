...
Guidelines for the core maintainers of the cisco_rpc project - above and beyond the [general developer guidelines](https://github.com/cisco/cisco-nxapi/blob/master/CONTRIBUTING.md).
...
5. Publish the new gem version to rubygems.org:
    ...
    ```
    gem build cisco_rpc.gemspec
    gem push cisco_rpc-1.0.1.gem
    ```
